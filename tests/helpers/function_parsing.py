...
def build_registries_from_source(
    source: str,
    ...
    Returns:
        Tuple of (AST tree, class registry, variable registry, import registry)
    """
    tree = ast.parse(source)
    class_registry = build_class_registry(tree)
    variable_registry = build_variable_registry(tree, class_registry)
    import_registry = build_import_registry(tree)
    return tree, class_registry, variable_registry, import_registry
